    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                <a href="#" class="list-group-item">수강중인 클래스</a>
                <a href="#" class="list-group-item">팔로잉 멘토</a>
                <a href="#" class="list-group-item">클래스 리뷰</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="http://placehold.it/700x500" alt=""></a>
                        <div class="card-body">
                            <h4 class="card-title">
