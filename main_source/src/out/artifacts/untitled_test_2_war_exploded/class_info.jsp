                    ...
                    <!--<div class="row">-->
                        <div class="col-lg-12">
                            <ul class="list-unstyled mb-0">
                                <li><input type="checkbox" value="A">
                                    <a> 매주 화요일 13:00~16:00 사당역</a>
                                </li>
                                <li><input type="checkbox" value="B">
                                    <a> 매주 수요일 13:00~16:00 학동역</a>
                                </li>
                                <li><input type="checkbox" value="C">
                                    <a> 매주 금요일 13:00~16:00 사당역</a>
                                </li>
                            </ul>

                            <br>
                            <br>
                            <input type="submit" title="수업등록하기" value="수업등록">
                        </div>
                        <!--<div class="col-lg-6">
                            <ul class="list-unstyled mb-0">
                                <li>
